...
def _perform_inventory_sync(app):
"""Implements true "latest-wins" two-way sync logic."""
sync_start_time = datetime.datetime.now(datetime.timezone.utc)
app.log_sync_activity("=== STARTING SYNC (Latest-Wins) ===")
try:
